import type { Document, Entity, Relation, GraphData, MergeResult } from "./types";
...
export async function uploadDocument(file: File): Promise<{ success: boolean; documentId: number; entityId: number }> {
